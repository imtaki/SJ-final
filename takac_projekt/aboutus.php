...
?>
  	  ...
  	  <div class="container">
  	  	  <div class="content">
  	  	  	   <div class="box">
  	  	  	   	   <div class="inner">
  	  	  	   	   	   <div class="img">
  	  	  	   	   	   	  <img src="img/mealplan.jpg" alt="service" />
  	  	  	   	   	   </div>
                       <div class="text">
  ...
  <h2 class="text-center">Socialne stranky nasich trenerov</h2>
  <div class="table-responsive">
  <table class="table table-hover table-dark table-sm mx-auto w-auto">
    <thead>
      <tr>
        <th scope="col">#</th>
        <th scope="col">First</th>
        <th scope="col">Last</th>
        <th scope="col">Handle Instagram</th>
      </tr>
    </thead>
    <tbody>
      <tr>
